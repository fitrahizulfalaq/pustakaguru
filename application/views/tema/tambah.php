			...
			<div class="card-body">
				<div class="p-1">
					<div class="text-center">
						...
						<!-- <p>Penambahan Materi untuk Kelas <?= $this->uri->segment("3")?></p> -->
						<p>Penambahan Materi</p>
					</div>
					<?= form_open_multipart('') ?>
					...
					<div class="form-group basic animated">
						<div class="input-wrapper">
							...
							<input type="text" name="deskripsi" class="form-control" id="deskripsi" placeholder="Judul Tema Materi" value="<?= set_value('deskripsi');?>" required>
							<i class="clear-input">
